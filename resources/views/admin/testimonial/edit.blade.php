            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('testimonial.update', $data->id) }}" enctype="multipart/form-data">
                            @csrf @method('PUT')
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Name</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="name" placeholder="Testifier Name" value="{{ $data->name }}" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="elm1" type="text" name="desc" placeholder="Enter Testimony..." >
                                        {{ $data->desc }}
                                    </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img src="{{ asset($data->image) }}" width="70">
                                </div>
                            </div>
                            <!-- end row -->
