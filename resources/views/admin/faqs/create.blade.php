                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('faqs.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="question" placeholder="Question" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="elm1" type="text" name="answer" placeholder="Enter Answer..." ></textarea>
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="btn btn-primary" type="submit" value="Add FAQs">
                                </div>
                            </div>
                            <!-- end row -->
                        </form>
