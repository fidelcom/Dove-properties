                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('team.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="name" placeholder="Team Member Name" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="position" placeholder="Position" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="instagram" placeholder="https://instagram.com/username" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="linkedin" placeholder="https://linkedin.com/username" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="twitter" placeholder="https://twitter.com/username" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
