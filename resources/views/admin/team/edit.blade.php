                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('team.update', $data->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="position" value="{{ $data->position }}" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="instagram" value="{{ $data->instagram }}" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="linkedin" value="{{ $data->linkedin }}" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="twitter" value="{{ $data->twitter }}" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
