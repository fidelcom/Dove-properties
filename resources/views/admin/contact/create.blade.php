        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Contact Details</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('contact.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="phone" placeholder="Phone No" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="url" name="instagram" placeholder="Instagram Link" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="url" name="twitter" placeholder="Twitter Link" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="url" name="linkedin" placeholder="Linkedin Link" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="btn btn-primary" type="submit" value="Add Contact Details">
                                </div>
                            </div>
                            <!-- end row -->
                        </form>
